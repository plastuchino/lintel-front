...
export const jobs = {
  getQuotePreview: (address: string, coords?: { lat: number; lng: number }) =>
    api.post<{ quotes: Record<ServiceType, number>; lat: number; lng: number }>('/jobs/quote/preview', { address, ...coords }),
