...
const WHAT_WE_DO = [
  ['Multi-building & multi-story properties', 'Retail centers, warehouses, and multi-unit properties — longer gutter runs and higher rooflines than a typical residential job.'],
  ['Storefront gutter runs', 'Clearing and flushing gutter systems along storefronts and loading areas so water drains away from entrances and signage.'],
  ['Recurring maintenance contracts', 'Quarterly or biannual scheduled service so gutter maintenance is never something your team has to remember to call in.'],
  ['Downspout & drainage checks', 'Every downspout confirmed flowing before we leave — critical for properties where standing water is a liability concern.'],
];
...
const FAQ_ITEMS = [
  ...
  {
    q: 'Can you handle multi-building or multi-story commercial properties?',
    a: 'Yes. Commercial gutter work often means multiple buildings, longer runs, and higher rooflines than residential jobs — we scope those separately from our standard residential ground-level equipment and bring the right crew size and equipment for the property.',
  },
  {
    q: 'Do you offer recurring/scheduled gutter maintenance contracts?',
    a: "Yes, this is common for retail and commercial properties with heavy tree coverage or liability concerns around downspout drainage. We can set up quarterly or biannual service on a standing schedule so it's never something your team has to remember to call in.",
  },
  {
    q: 'Can you work around our operating hours?',
    a: 'Yes. We schedule around store hours, deliveries, and customer traffic — early morning, after close, or whatever minimizes disruption to your operation.',
  },
];
...
export default function CommercialGutterCleaning() {
  ...
  return (
    <div className="min-h-screen bg-white text-black pb-16 lg:pb-0" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      <Helmet>
        <title>Commercial Gutter Cleaning in Montgomery County, MD | Lintel</title>
        <meta name="description" content="Commercial gutter cleaning for retail, warehouse, and multi-unit properties in Montgomery County, MD. Fully insured, recurring contracts available." />
        <link rel="canonical" href="https://uselintel.pro/commercial/gutter-cleaning" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Commercial Gutter Cleaning in Montgomery County, MD | Lintel" />
        <meta property="og:description" content="Commercial gutter cleaning for retail, warehouse, and multi-unit properties. Fully insured, recurring contracts available." />
        <meta property="og:url" content="https://uselintel.pro/commercial/gutter-cleaning" />
      </Helmet>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        description: 'Commercial gutter cleaning for retail, warehouse, and multi-unit properties, including recurring maintenance contracts.',
        url: 'https://uselintel.pro/commercial/gutter-cleaning',
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-black/10">
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            <Link to="/commercial/gutter-cleaning" className="px-4 h-9 flex items-center text-black text-[11px] font-semibold tracking-[0.12em] uppercase border-b-2 border-black">Gutters</Link>
      ...
      <section ref={heroRef} className="pt-14 bg-[#0d0d0d] min-h-[60vh] flex flex-col relative overflow-hidden">
        <img src={gutter_image} className="absolute inset-0 w-full h-full object-cover object-center opacity-50" alt="" />
        ...
        <div className="relative z-10 flex-1 w-full max-w-6xl mx-auto px-6 py-12 flex flex-col lg:flex-row lg:items-center lg:gap-16">
          <div className="flex-1 mb-8 lg:mb-0">
            ...
            <h1 className="text-4xl lg:text-5xl font-black text-white leading-tight uppercase mb-4 max-w-xl">
              Commercial Gutter Cleaning<br />for Businesses {h1Location}
            </h1>
            {!geoResolved && (
              <button
            ...
            <p className="text-white/60 text-sm leading-relaxed max-w-sm">
              Retail centers, warehouses, and multi-unit properties. Recurring contracts available. Payment collected only after the job is confirmed done.
            </p>
          </div>
          <div className="w-full lg:w-[380px] lg:flex-shrink-0">
            <CommercialQuoteCTA serviceType="gutter-cleaning" />
          </div>
        </div>
      </section>
        ...
        <div className="lg:grid lg:grid-cols-[1fr_380px] lg:items-start">
          ...
          <div className="hidden lg:block border-l border-black/10">
            <div className="sticky top-14 px-8 py-10">
              <CommercialQuoteCTA serviceType="gutter-cleaning" className="w-full" />
            </div>
          </div>
        </div>
      </div>
